...
export const SEARCH_TOURNAMENTS_REQUEST_SUCCESS =
  "SEARCH_TOURNAMENTS_REQUEST_SUCCESS";
...
export const loaderStatus = createSelector(
  stateSelector,
  state => state.loader
);
...
export const searchSaga = function*(payload) {
  ...
  try {
    const tournaments = yield call(axios, url.baseUrl(pattern));
    yield put({
    ...
    // TODO crete error handler
  }
};

export const saga = function*() {
  yield all([takeEvery(SEARCH_TOURNAMENTS_REQUEST, searchSaga)]);
};
